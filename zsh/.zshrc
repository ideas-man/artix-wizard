...
source_conda ()
{
    ...
    __conda_setup="$('/home/ideasman/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
    if [ $? -eq 0 ]; then
        eval "$__conda_setup"
    else
        if [ -f "/home/ideasman/anaconda3/etc/profile.d/conda.sh" ]; then
            . "/home/ideasman/anaconda3/etc/profile.d/conda.sh"
        else
            export PATH="/home/ideasman/anaconda3/bin:$PATH"
        fi
    fi
    unset __conda_setup
    # <<< conda initialize <<<
